                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown" >
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="#" id="menu"><i class="fas fa-bookmark"></i> Luis Antonio de Jesús López </a>
                            <a class="dropdown-item" href="#" id="menuMostrarUsuario"><i class="fas fa-bookmark"></i> Eduardo Félix Alba </a>
                            <a class="dropdown-item" href="#" id="menuMostrarUsuario"><i class="fas fa-bookmark"></i> David González Martínez </a>
                            <a class="dropdown-item" href="#" id="menuMostrarUsuario"><i class="fas fa-bookmark"></i> José Alex Reyes Juaréz </a>
                        </div>
                    </li>
                    <li class="nav-item dropdown" >
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" style="color: white;">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropDownMenuLink">
                            <a class="dropdown-item" href="#" id="menuMostrarUsuario"><i class="fas fa-book-open"></i> Trabajos en equipo </a>
                            <a class="dropdown-item" href="#" id="menuAgregarUsuario"><i class="fas fa-bookmark"></i> Luis Antonio de Jesús López </a>
                            <a class="dropdown-item" href="#" id="menuMostrarUsuario"><i class="fas fa-bookmark"></i> Eduardo Félix Alba </a>
                            <a class="dropdown-item" href="#" id="menuMostrarUsuario"><i class="fas fa-bookmark"></i> David González Martínez </a>
                            <a class="dropdown-item" href="#" id="menuMostrarUsuario"><i class="fas fa-bookmark"></i> José Alex Reyes Juaréz </a>
                        </div>
