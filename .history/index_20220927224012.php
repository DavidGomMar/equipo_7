        ...
        <div class="row" id="divInicio">
            <div class="col-12" style="text-align: center;">
                ...
                <h1 class="animate__animated animate__backInLeft"><font color="#121116" size="6" >
                    <b>Tecnologico De Estudios Superiores de San Felipe del Progreso </b> <br> <br>
                    <b>Pagina donde se suben los trabajos de los cortes</b> <br> <br>
                    <b>ING. Luis Angel Gonzalez Flores</b> <br> <br>
                    <b>Carrera: ingenieria Informatica  </b> <br> <br>
                    <b>Grupo: 701</b> <br> <br>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <a href="trabajos_equipo/caso practico.pdf" class="btn btn-primary">PENDIENTE</a>
                                                    </div>
                                        </div>
                                    </div>
