                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    <img class="img-fluid" href="" alt="100%x280" src="img/casos.png">
                                                    <div class="card-body">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text" style="color:black;">Descripcion.</p>
                                                        <a href="trabajos_indi/infividual_luis/Fundamentos de gestión de negocios (BPM).pdf" class="btn btn-primary">Ver Documento</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    <img class="img-fluid" alt="100%x280" src="img/cuadro_com.png">
                                                    <div class="card-body">
                                                        <h4 class="card-title">Mapa Conceptual</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    <img class="img-fluid" alt="100%x280" src="img/cuadro_com.png">
                                                    <div class="card-body">
                                                        <h4 class="card-title">Reportes de videos</h4>
                                                        <p class="card-text">Descripcion.</p>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card">
                                            <img class="img-fluid" alt="100%x280" src="img/cuadro_com.png">
                                                <div class="card-body">
                                                    <h4 class="card-title">Compra tradicional vs e-commerce</h4>
                                                    <p class="card-text">Descripcion.</p>
