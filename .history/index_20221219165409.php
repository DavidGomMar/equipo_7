                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    <img class="img-fluid" href="" alt="100%x280" src="img/2do_corte/Individual/Luis/Reportes videos Luis.jpeg">
                                                    <div class="card-body">
                                                        <h4 class="card-title" style="color:black;">5.2 Administración de SI</h4>
                                                        <p align = "justify" class="card-text" style="color:black;">Define las estrategias y modelos de desarrollo de aplicaciones y arquitectura. Contiene estrategias sin
