    ...
    <div class="container">
        ...
        <div class="row" id="divInicio">
            <div class="col-12" style="text-align: center;">
                ...
                <h1 class="animate__animated animate__backInLeft"><font color="#121116" size="6" >
                    ...
                    <font color="#121116" size="4" > El estudiante deberá tomar un rol activo en cada tema de aprendizaje que le permitan 
                        desarrollar capacidades tanto específicas como genéricas a través de actividades de investigación principalmente documental
                        y donde sea posible de campo, que lo conduzcan a un análisis, argumentación, evaluación, valoración, integración e  
                        interpretación de información que lo lleven a comprender la importancia de gestionar y alinear estratégicamente los 
                        servicios de TI que generen valor agregado a los procesos, productos y servicios de una organización. </font>  <br> <br>
        ...
        <div class="row" id="divtrabajosequipoC1" style="display: none;">
            <h1><font color="#121116" size="6" ><b>Objetivo de la unidad</b></font><br>
                <font color="#121116" size="4" >Identifica la estructura de la organización y el impacto de las tecnologías de información en sus procesos de negocio.
                </font></h1>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text" style="color:black;">el contenido y resumen de los videos nos da un enfoque explicito de los conocimientos básicos que debemos de saber acerca de la malatería dado que en ambos nos menciona el enfoque que se le da al sector empresaria.</p>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text" style="color:black;">Trabajamos con un cuadro en el cual describimos todas las herramientas para la obtención de información escribiendo así componentes físicos y digitales..</p>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text" style="color:black;">En este pequeño diagrama hablamos de todas las funciones que nosotros necesitamos como usuarios de las herramientas ti y que hacer para evaluar las necesidades..</p>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text" style="color:black;">Describimos la definición de fundamentos de gestión de procesos de negocio además hablamos de los ejemplos y todos los procesos que se tienen que llevar a cabo para la gestión de un negocio correcto.</p>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text" style="color:black;">Resumen hecho con la finalidad de saber cuáles son los objetivos de implementar las herramientas de TI.</p>
                                                        <a href="trabajos_indi/individual_alex/Fundamentos de gestion.pdf" class="btn btn-primary">Ver Documento</a>
                                                    </div>
                                        </div>
                                    </div>
                                ...
                                <div class="carousel-inner">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p align="justify" class="card-text" style="color:black;">Evolución de la infraestructur de la TI considerando las microcomputadoras,
                                                        las computadoras en general, la era cliente/servidor y computacion empresarial además de la computación en la nube</p>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <h4 class="card-title" style="color:black;"> Caso de estudio - Es el momento de la computación en la nube</h4>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p align="justify" class="card-text" style="color:black;">La computación usable está popularizarse prometiendo cambiando la forma de nuestro diario 
                                    ...
                                    <div class="carousel-item">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    <img class="img-fluid" alt="100%x280" src="img/2do_corte/Equipo/Competencia con la ayuda de la tecnología de la información.jpeg">
                                                    <div class="card-body">
                                                        <h4 class="card-title" style="color:black;">Competencia con la ayuda de la tecnología de la información</h4>
                                                        ...
                                                        información para proporcionar el apoyo efectivo de las estrategias de una empresa</p>
                                                        <a href="trabajos_equipo/corte_dos/Competencia con la ayuda de la tecnología de la información.pdf" class="btn btn-primary">Ver Documento</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    <img class="img-fluid" alt="100%x280" src="img/2do_corte/Equipo/Impulso de la Gestión de flotillas de ARI.jpeg">
                                                    <div class="card-body">
                                                        <h4 class="card-title" style="color:black;"> Impulso de la Gestión de flotillas de ARI</h4>
                                                        <p align="justify" class="card-text" style="color:black;">se observa que cada uno de los escalones  que ARI subía se debía a que identificaba las fallas en la estructura 
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        su infraestructura y mejorar su administración y desarrollo de actividades..</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <h4 class="card-title" style="color:black;">Reportes de videos</h4>
                                                        <p align = "justify" class="card-text" style="color:black;">Reportes de Introducción a Infraestructura de TI y INFRAESTRUCTURA TI EN LA EMPRESA en donde
                                                    nos hablan sobe las infraestructuras de las TI en las empresas que son servicios que proporcionan un conjunto de dispositivos físicos y de 
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <h4 class="card-title" style="color:black;">Apunte Tecnológias de la información y estrategias empresariales</h4>
                                                        ...
                                                        <a href="trabajos_indi/individual_luis/2doCorte/Apunte Tecnológias de la información y estrategias empresariales.pdf" class="btn btn-primary">Ver Documento</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p align="justify" class="card-text" style="color:black;">Los S.I. de apoyo proporcionan apoyo de información interactiva a administradores
                                        ...
                                        <div class="card">
                                            <img class="img-fluid" alt="100%x280" src="img/2do_corte/Individual/Luis/CISC y RISC Luis.jpeg">
                                                <div class="card-body">
                                                    ...
                                                    <p align="justify" class="card-text" style="color:black;">RISC: Procesadores diseñados para ejecta un numero de instrucciones reducidas.</p>
                                        ...
                                        <div class="card">
                                            <img class="img-fluid" alt="100%x280" src="img/2do_corte/Individual/Luis/Gobierno TI.jpeg">
                                                <div class="card-body">
                                                    ...
                                                    <p align="justify" class="card-text" style="color:black;">Sistema por el cual se rige y se controla la utilización de las TI actuales y futuras y
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text" style="color:black;">Las tecnologías de la información son técnicas métodos y procesos que se usan para 
                                                        la producción de bienes o servicios o en el logro de objetivos, como la investigación científica enfocado a los modelos de negocios.</p>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text" style="color:black;">La evolución de la estructura de TI a través de las etapas hasta llegar su 
                                                        proceso industrial hasta aplicaciones móviles que hoy en día se usan</p>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    <img class="img-fluid" alt="100%x280" src="img/2do_corte/Individual/Eduardo/Apoyo a la toma de decisiones en los negocios_Eduardo Félix Alba.jpeg">
                                                    <div class="card-body">
                                                        <h4 class="card-title" style="color:black;">Apoyo a la toma de decisiones en los negocios</h4>
                                                        <p class="card-text" style="color:black;">Los sistemas de apoyo a la toma de decisiones son sistemas de información basados en la 
                                                        computadora que proporcionan combinación de prácticas, capacidades y tecnologías usadas por las compañías</p>
                                                        <a href="trabajos_indi/individual_eddy/2doCorte/Apoyo a la toma de decisiones en los negocios_Eduardo Félix Alba.pdf" class="btn btn-primary">Ver Documento</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="carousel-item">
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    <img class="img-fluid" alt="100%x280" src="img/2do_corte/Individual/Eduardo/Gobierno de las TI_Eduardo Félix Alba.jpeg">
                                                    <div class="card-body">
                                                        <h4 class="card-title" style="color:black;">Gobierno TI</h4>
                                                        <p class="card-text" style="color:black;">El Gobierno de TI es una responsabilidad del más alto nivel directivo 
                                                        y se encuentra en lo más alto de las operaciones de TI y la gestión de TI.</p>
                                                        <a href="trabajos_indi/individual_eddy/2doCorte/Gobierno de las TI_Eduardo Félix Alba.pdf" class="btn btn-primary">Ver Documento</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="card">
                                                <img class="img-fluid" alt="100%x280" src="img/2do_corte/Individual/Eduardo/Infraestructura de TI y tecnologías emergentes_Eduardo Félix Alba.jpeg">
                                                <div class="card-body">
                                                    <h4 class="card-title" style="color:black;">Infraestructura de TI y tecnologías emergentes</h4>
                                                    <p class="card-text" style="color:black;">Podemos saber que la infraestructura de TI  son el conjunto de dispositivos físicos y aplicaciones 
                                                    de software que son necesarios para que opere una empresa</p>
                                                    <a href="trabajos_indi/individual_eddy/2doCorte/Infraestructura de TI y tecnologías emergentes_Eduardo Félix Alba.pdf" class="btn btn-primary">Ver Documento</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <h4 class="card-title" style="color:black;">Reporte de Lectura Introducción a Infraestructura de TI</h4>
                                                        <p align="justify" class="card-text" style="color:black;">nos demuestra lo que hace un administrador de datos así como herramientas, 
                                                        componentes para diferentes arias de una red LAN</p>
                                                        <a href="trabajos_indi/individual_dav/2doCorte/Reporte de Lectura Introducción a Infraestructura de TI.pdf" class="btn btn-primary">Ver Documento</a>
                                                    </div>
                                                </div>
                                            </div>
                                </div>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    <img class="img-fluid" alt="100%x280" src="img/2do_corte/Individual/Alex/Comprensión de la función de tecnologías de la investigación.jpeg">
                                                    <div class="card-body">
                                                        <h4 class="card-title" style="color:black;">Comprensión de la función de tecnologías de la investigación</h4>
                                                        <p align="justify" class="card-text" style="color:black;">Conocer las estrategias para la implementación de tecnologías 
                                                                en los negocios y tener en cuenta su evaluación y evolución del negocio.</p>
                                                        <a href="trabajos_indi/individual_alex/2doCorte/Comprensión de la función de tecnologías de la investigación.pdf" class="btn btn-primary">Ver Documento</a>
                                                    </div>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    <img class="img-fluid" alt="100%x280" src="img/2do_corte/Individual/Alex/Funciones de administración de datos alex2.jpeg">
                                                    <div class="card-body">
                                                        <h4 class="card-title" style="color:black;">Funciones de administración de datos, extracción, relación, integración y recopilación de datos.</h4>
                                                        <p align="justify" class="card-text" style="color:black;">Se cuestiona la forma de tomar decisiones en cuanto al desarrollo de los negocios además de la implementación
                                                                            de la tecnología para su mejora en ventas, desarrollo, etc.</p>
                                                        <a href="trabajos_indi/individual_alex/2doCorte/Funciones de administración de datos, extracción, relación, integración y recopilación de datos..pdf" class="btn btn-primary">Ver Documento</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        cual se encarga de liderar todos los procesos de implementación de tecnología en los negocios.</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    <img class="img-fluid" alt="100%x280" src="img/2do_corte/Individual/David/Infraestructura de TI y tecnologias emergentes.png">
                                                    <div class="card-body">
                                                        <h4 class="card-title" style="color:black;">Formato de reporte de lectura Introducción a Infraestructura de TI.</h4>
                                                        ...
                                                        <a href="trabajos_indi/individual_dav/2doCorte/Formato de reporte de lectura Introducción a Infraestructura de TI.pdf" class="btn btn-primary">Ver Documento</a>
                                                    </div>
                                                </div>
                                            </div>
                            </div>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    <img class="img-fluid" alt="100%x280" src="img/fotos_conferencias/conferencias.jfif">
                                                    <div class="card-body">
                                                        <h4 class="card-title" style="color:black;">Todas las conferencias :v</h4>
                                                        <p align="justify" class="card-text" style="color:black;"></p>
                                                        <a href="conferencias/Conferencia 1.pdf" class="btn btn-primary">Ver Documento</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
