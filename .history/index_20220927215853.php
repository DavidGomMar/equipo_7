                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <h4 class="card-title">Fundamentos de gestion</h4>
                                                        <p class="card-text">Describimos la definición de fundamentos de gestión de procesos de negocio además hablamos de los ejemplos y todos los procesos que se tienen que llevar a cabo para la gestión de un negocio correcto.</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <h4 class="card-title">alineacion de los servidores.pdf</h4>
                                                        <p class="card-text">Resumen hecho con la finalidad de saber cuáles son los objetivos de implementar las herramientas de TI.</p>
                                                        <a href="trabajos_indi/individual_alex/Fundamentos de gestion.pdf" class="btn btn-primary">Ver Documento</a>
                                                    </div>
                                        </div>
                                    </div>
