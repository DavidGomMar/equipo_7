                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    <img class="img-fluid" href="trabajos_indi/individual_luis/1.4 alineación de los objetivos de las tecnologías en la información.pdf" alt="100%x280" src="img/casos.png">
                                                    <div class="card-body">
                                                        <h4 class="card-title">Alineacion de los objetivos de las tecnologias</h4>
                                                        <p class="card-text">Descripcion.</p>
                                                        <a href="trabajos_equipo/Casos_de_estudio.pdf" class="btn btn-primary">Ver Documento</a>
                                                    </div>
