    ...
    <div class="container">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown" >
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="#" id="menuLuisDJC1"><i class="fas fa-bookmark"></i> Luis Antonio de Jesús López </a>
                    ...
                    <li class="nav-item dropdown" >
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropDownMenuLink">
                            ...
                            <a class="dropdown-item" href="#" id="menuLuisDJC2"><i class="fas fa-bookmark"></i> Luis Antonio de Jesús López </a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropDownMenuLink">
                            ...
                            <a class="dropdown-item" href="#" id="menuLuisDJC3"><i class="fas fa-bookmark"></i> Luis Antonio de Jesús López </a>
        ...
        <div class="row" id="divInicio">
            <div class="col-12" style="text-align: center;">
                ...
                <br>
                <img src="img/cecy.png" alt="" style="">
            </div>
        </div>
